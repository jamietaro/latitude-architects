  ...
  async function handleSave() {
    ...
    try {
      const res = await fetch("/api/admin/careers", {
        ...
        body: JSON.stringify({ heading, intro, vacancies }),
      });
  ...
  return (
    <div className="h-screen bg-[#111] flex flex-col">
      <div className="flex items-center gap-3 p-4 border-b border-[#2a2a2e]">
        <h1 className="text-white text-sm font-normal flex-1">Careers page</h1>
      ...
      <div className="flex-1 overflow-y-auto p-6">
        <div className="max-w-[640px] space-y-6">
          <p className="text-[#666] text-xs">
            Full content of the public /practice/careers page. Vacancies are
            rendered as a separate block below the intro.
          </p>
          ...
          <div>
            ...
            <TiptapEditor content={vacancies} onChange={setVacancies} />
          </div>
        </div>
      </div>
    </div>
